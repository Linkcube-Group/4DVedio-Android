...
import me.linkcube.fourdvedio.bluetooth.BluetoothDeviceReceiver;
import me.linkcube.fourdvedio.bluetooth.BluetoothUtils;
import me.linkcube.fourdvedio.bluetooth.OnBluetoothDeviceListener;
...
public class BluetoothSettingActivity extends DialogActivity implements
	...
	public void onClick(View v) {
		...
		case R.id.bluetooth_help_btn:
			startActivity(new Intent(BluetoothSettingActivity.this,
					BluetoothHelpActivity.class));
